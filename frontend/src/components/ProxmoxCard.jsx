...
function ProxmoxCard({ resource, onStart, onStop, onReboot, isAdmin }) {
  ...
  return (
    <div className="group relative bg-white/70 dark:bg-white/5 backdrop-blur-md rounded-3xl border border-gray-400/60 dark:border-white/10 shadow-xl hover:shadow-2xl transition-all duration-200 p-6 flex flex-col gap-2 will-change-auto hover:border-blue-500/70 dark:hover:border-blue-500/60 hover:scale-[1.025]">
